...
```{r}
# This code sets the working directory. It tells R where to find the data and how to import it. Here, we're telling R that our working directory is "REPO NAME/2021_ProblemSet3_RCompanion." 

setwd("~/REPO NAME/2021_ProblemSet3_RCompanion")
...
*Can you guess what the square brackets in the above code chunk do? Does the first value (before the comma) indicate the rows or the columns you wish to select?*
